...
const page = () => {
  return (
    <div className="mt-2 md:px-10 lg:ml-80 lg:mr-80 bg-black border border-gray-500 rounded-xl shadow-2xs px-130 text-white">
        <div className="p-6 sm:px-50">
          <div className="text-center py-8 px-20 w-full max-w-md">
